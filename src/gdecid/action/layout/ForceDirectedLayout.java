...
import gdecid.util.force.DragForce;
import gdecid.util.force.ForceItem;
import gdecid.util.force.ForceSimulator;
import gdecid.util.force.NBodyForce;
import gdecid.util.force.SpringForce;
 ...
 * this value.</p>
 * 
 * <p>The {@link gdecid.util.force.ForceSimulator} used to drive this layout
 ...
 * {@link gdecid.util.force.Force} components. Each node in the layout is
 * mapped to a {@link gdecid.util.force.ForceItem} instance and each edge
 * to a {@link gdecid.util.force.Spring} instance for storing the state
 * of the simulation. See the {@link gdecid.util.force} package for more.</p>
 * 
