...
public abstract class AbstractForce implements Force {
    ...
    /**
     * @see gdecid.util.force.Force#getParameterCount()
     */
    ...
    /**
     * @see gdecid.util.force.Force#getParameter(int)
     */
    ...
    /**
     * @see gdecid.util.force.Force#getMinValue(int)
     */
    ...
    /**
     * @see gdecid.util.force.Force#getMaxValue(int)
     */
    ...
    /**
     * @see gdecid.util.force.Force#getParameterName(int)
     */
    ...
    /**
     * @see gdecid.util.force.Force#setParameter(int, float)
     */
    ...
    /**
     * @see gdecid.util.force.Force#setMinValue(int, float)
     */
    ...
    /**
     * @see gdecid.util.force.Force#setMaxValue(int, float)
     */
    ...
    /**
     * Returns false.
     * @see gdecid.util.force.Force#isItemForce()
     */
    ...
    /**
     * Returns false.
     * @see gdecid.util.force.Force#isSpringForce()
     */
     ...
     * @see gdecid.util.force.Force#getForce(gdecid.util.force.ForceItem)
     */
    ...
    /**
     * Throws an UnsupportedOperationException.
     * @see gdecid.util.force.Force#getForce(gdecid.util.force.Spring)
     */
